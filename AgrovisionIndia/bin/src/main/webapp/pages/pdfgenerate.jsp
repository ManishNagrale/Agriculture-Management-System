...
<head>
    ...
    <title>AgrovisionIndia PDF</title>
...
<aside>
  ...
  <div>
    <div>
      <b>All Rights Reseved By AgrovisionIndia</b>
      <p>
     ...
     <div>
      ...
      <ul>
        <img src="img/Signature.jpg" alt="" width="200px;">
      </ul>
    </div>
  </div>
...
<script>
    ...
    const options = {
      margin: 0.001,
      filename: 'SoilReceiptAgrovision.pdf',
      image: { 
        type: 'jpeg', 
        quality:1000
      },
