                ...
                <a href="product">
                    <div class="service-item bg-light text-center p-5" style="border-radius: 32px;">
                       <i class="fa-solid fa-cart-shopping display-1 text-primary mb-3"></i>
                        <h4>Quick enquiry</h4>
                        <p class="mb-0">These quick inquiry services are designed to offer users immediate and valuable information related to their specific needs in the areas of crops, fertilizers, vegetables, seeds, and fruits on the Agrovision platform.</p>
                    </div>
                     </a>
                </div>
                <div class="col-lg-4 col-md-6" >
                    ...
                    <div class="row g-0">
                        <div class="col-10">
                            <div class="position-relative">
                                <img class="img-fluid w-100"  alt="" style="height: 400px; " >
