...
<head>
    <meta charset="utf-8">
    <title>AgrovisionIndia Login</title>
                    ...
                    <div class="bg-secondary h-100 p-5">
                        ...
                        <div class="d-flex mb-4">
                            ...
                            <div class="ps-3">
                                ...
                                <span class="text-white">Chh.Sambhajinagar,Maharashtra</span>
                            </div>
                        </div>
                        <div class="d-flex mb-4">
                            <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center" style="width: 60px; height: 60px;">
                            ...
                            <div class="ps-3">
                                ...
                                <span class="text-white">anandjadhav5559@gmail.com</span>
                            </div>
                        </div>
                        <div class="d-flex">
                            <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center" style="width: 60px; height: 60px;">
                            ...
                            <div class="ps-3">
                                ...
                                <span class="text-white">+91 9373767625</span>
                            </div>
                        </div>
                    </div>
                </div>
