...
<!-- Markee start -->
    <div class="marquee-container">
        <marquee class="marquee">
            AgrovisionIndia AgroAgency Registration Portal - Register your AgroAgency With Us,Submit Your Details Now , 100% Online Process. | For Any Query Contact our HelplineNumber.
        </marquee>
    </div>
                ...
                <div class="carousel-item active" >
                    ...
                    <div class="carousel-caption top-0 bottom-0 start-0 end-0 d-flex flex-column align-items-center justify-content-center">
                        <div class="text-start p-5" style="max-width: 900px;">
                            ...
                            <p class="text-white" style="font-size: 30px;">AgrovisionIndia is a web-based open discussion portal. </p>
