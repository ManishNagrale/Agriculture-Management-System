...
<body>
        ...
        <div class="row gx-5 py-3 align-items-center">
            <div class="col-lg-3" style="color: darkslategrey;font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman',">
                <div class="d-flex align-items-center justify-content-start">
                    ...
                    <h2 class="mb-0">+91 9373767625</h2>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="d-flex align-items-center justify-content-center">
                    <a href="index.html" class="navbar-brand ms-lg-5">
                        <h1 class="m-0 display-4 text-primary"><span class="text-secondary">Agrovision</span>India</h1>
                    </a>
                </div>
            </div>
            ...
            <div class="col-lg-3">
               <div class="d-flex align-items-center justify-content-end">
                    <a class="btn btn-primary btn-square rounded-circle me-2" href="https://twitter.com/AnandJadha58085"><i class="fab fa-twitter"></i></a>
                    <a class="btn btn-primary btn-square rounded-circle me-2" href="https://www.facebook.com/AmitKale/"><i class="fab fa-facebook-f"></i></a>
                    <a class="btn btn-primary btn-square rounded-circle me-2" href="https://www.linkedin.com/in/anandjadhav29/"><i class="fab fa-linkedin-in"></i></a>
                    <a class="btn btn-primary btn-square rounded-circle" href="https://www.instagram.com/amit.kale05/"><i class="fab fa-instagram"></i></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <nav class="navbar navbar-expand-lg bg-primary navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-5">
        <a href="index.html" class="navbar-brand d-flex d-lg-none">
            <h1 class="m-0 display-4 text-secondary"><span class="text-white">Agrovision</span>India</h1>
        </a>
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item" >
                    ...
                    <div class="carousel-caption top-0 bottom-0 start-0 end-0 d-flex flex-column align-items-center justify-content-center">
                        <div class="text-start p-5" style="max-width: 900px;">
                            <h3 class="text-white">Welcome</h3>
                            <h1 class="display-1 text-white mb-md-4">Be the Part of AgrovisionIndia.</h1>
            ...
            <div class="row gx-0">
                ...
                <div class="col-md-6" >
                    <div class="bg-secondary bg-fruitfarm d-flex flex-column justify-content-center p-5" style="height: 300px;">
                        ...
                        <p class="text-white">"At Agrovision, we recognize the crucial role that weather conditions play in the success of farming. We understand that farmers need accurate and timely information to make informed decisions for their crops and livestock.</p>
                ...
                <div class="col-lg-6 pb-5">
                    ...
                    <div class="row gx-5 gy-4">
                        ...
                        <div class="col-sm-6">
                            ...
                            <h4>Award Winning</h4>
                            <p class="mb-0" style="color: black;"> Agrovision is working towards Agricultural Innovation Excellence Award. This recognition highlights our commitment to revolutionizing the agricultural landscape by providing cutting-edge solutions and fostering a community dedicated to sustainable farming practices. </p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-4 col-md-6">
                    ...
                    <p class="mb-4">At Agrovision, we are dedicated to providing a comprehensive suite of services designed to empower farmers and agricultural enthusiasts with the knowledge, resources, and support they need for successful and sustainable farming practices. </p>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="service-item bg-light text-center p-5" style="border-radius: 32px;">
                       ...
                       <i class="fa-solid fa-magnifying-glass-chart display-1 text-primary mb-3"></i>
                        <h4>Soil Analysis</h4>
                        <p class="mb-0">Agrovision's Soil Analysis Service is your first step towards cultivating a thriving and sustainable agricultural venture.</p>
                    </div>
                </div>
               <div class="col-lg-4 col-md-6" >
                ...
                <div class="col-lg-4 col-md-6" >
                    ...
                    <div class="service-item bg-light text-center p-5" style="border-radius: 32px;">
                       <i  class="fa-solid fa-cloud-moon-rain display-1 text-primary mb-3"></i>
                        ...
                        <p class="mb-0">At Agrovision, we understand the pivotal role that weather conditions play in successful farming.,Access real-time weather information, including temperature, humidity  and more.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6" >
                    ...
                    <div class="service-item bg-light text-center p-5" style="border-radius: 32px;">
                        ...
                        <p class="mb-0">At Agrovision, we recognize the importance of continuous learning in the ever-evolving field of agriculture. Engage in interactive workshops and webinars covering a range of agricultural topics.</p>
                    </div>
                   ...
                   <a href="stutrain">
                    <div class="service-item bg-light text-center p-5" style="border-radius: 32px;">
                      <i  class="fa-solid fa-graduation-cap display-1 text-primary mb-3"></i>
                        ...
                        <p class="mb-0"> At  Agrovision Agro Student Training provides a distinctive platform for you to share your agricultural knowledge, offer specialized courses, and connect directly with aspiring agri-entrepreneurs and students. </p>
                    </div></a>
                </div>
            </div>
        </div>
            ...
            <div class="row g-5">
                <div class="col-lg-3">
                    ...
                    <div class="text-white">
                        ...
                        <p class="mb-0">Agrovision is working towards Agricultural Innovation Excellence Award.</p>
                    </div>
                </div>
                <div class="col-lg-6">
                        ...
                        <div class="col-10">
                            <div class="position-relative">
                                ...
                                <div class="position-absolute start-0 bottom-0 w-100 py-3 px-4" style="background: rgba(52, 173, 84, .85);">
                                    <h4 class="text-white">Amit Kale</h4>
                    ...
                    <div class="row g-0">
                        <div class="col-10">
                            <div class="position-relative">
                                ...
                                <div class="position-absolute start-0 bottom-0 w-100 py-3 px-4" style="background: rgba(52, 173, 84, .85);">
                                    <h4 class="text-white">Swapnil Mangate </h4>
                                    <span class="text-white">Developer</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row g-0">
                        <div class="col-10">
                            <div class="position-relative">
                                ...
                                <div class="position-absolute start-0 bottom-0 w-100 py-3 px-4" style="background: rgba(52, 173, 84, .85);">
                                    <h4 class="text-white">Anand Jadhav</h4>
                                    <span class="text-white">Developer</span>
                                </div>
                            </div>
                        </div>
   ...
   <div class="container-fluid py-5">
                    ...
                    <div class="row gx-5">
                        <div class="col-lg-4 col-md-12 pt-5 mb-5">
                            ...
                            <div class="d-flex mb-2">
                                ...
                                <p class="text-white mb-0">Sai Residency, B-1, 2nd Floor, Besides Sainik Vihar, Paithan Rd, Chh.Sambhajinagar, Maharashtra 411001</p>
                            </div>
                            <div class="d-flex mb-2">
                                <i class="bi bi-envelope-open text-white me-2"></i>
                                <p class="text-white mb-0">anandjadhav5559@gmail.com</p>
                            </div>
                            <div class="d-flex mb-2">
                                <i class="bi bi-telephone text-white me-2"></i>
                                <p class="text-white mb-0">9373767625</p>
                            </div>
                            <div class="d-flex mt-4">
                                <a class="btn btn-secondary btn-square rounded-circle me-2" href="https://twitter.com/anandjadhav58085"><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-secondary btn-square rounded-circle me-2" href="https://www.facebook.com/AmitKale/"><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-secondary btn-square rounded-circle me-2" href="https://www.linkedin.com/in/anandjadhav29/"><i class="fab fa-linkedin-in"></i></a>
                                <a class="btn btn-secondary btn-square rounded-circle" href="https://www.instagram.com/amit.kale05/"><i class="fab fa-instagram"></i></a>
                            </div>
                        </div>
    ...
    <div class="container-fluid bg-dark text-white py-4">
        <div class="container text-center">
            <p class="mb-0">&copy; <a class="text-secondary fw-bold" href="#">AgrovisionIndia.Com</a>. All Rights Reserved. Designed And Developed by <a class="text-secondary fw-bold" href=>Swapnil and team</a></p>
        </div>
    </div>
    <!-- Footer End -->
