...
<%@ taglib uri="http://www.springframework.org/tags/form" prefix="form" %>
  <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    ...
    <body>
      ...
      <header>
        <div class="logosec">
          <div class="logo">AgrovisionIndia</div>
        ...
        <div class="searchbar" style="margin-left:100px; padding:20px;">
          ...
          <input type="text" id="emailInput" onkeyup="searchBy('email')" placeholder="Search by Email">
          <div class="searchbtn">
            <i class="fa-solid fa-magnifying-glass"></i>
          </div>


          <input type="text" id="cityInput" onkeyup="searchBy('city')" placeholder="Search by City"
          ...
          <input type="text" id="townInput" onkeyup="searchBy('town')" placeholder="Search by Town"
            style="margin-left:20px;">
                    ...
                    <tr>
                      ...
                      <td>
                        <form action="searchagro" method="post">
                          ...
                          <button type="submit" style="background-color: #29bf12;width:100px"" class=" demo">Approve<i
                              class="fa-solid fa-check"></i></button>
                        </form>
                        <br>
                        <a href="reject/${e.id}"><button type="button" style="background-color: red;width:80px;"
                            class="demo">Reject<i class="fa-solid fa-xmark"></i></button></a>
